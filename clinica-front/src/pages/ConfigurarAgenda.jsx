                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                        {loading ? (
                            ...
                            <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                                ...
                                <td className={tdClass}><div className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full font-black text-[10px] ${item.total_agendados > 0 ? 'bg-blue-100 text-blue-700' : 'bg-slate-100 text-slate-500'}`}><Users size={10}/> {item.total_agendados}</div></td>
