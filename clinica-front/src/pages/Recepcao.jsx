                            ...
                            <div className="p-6 space-y-8">
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-4">
                                        ...
                                        <div><label className={labelClass}>Forma de Pagamento</label><select value={formCheckin.forma_pagamento} onChange={e => setFormCheckin({...formCheckin, forma_pagamento: e.target.value})} className={inputClass}><option value="dinheiro">💵 Dinheiro</option><option value="pix">📱 Pix</option><option value="cartao_credito">💳 Crédito</option><option value="cartao_debito">💳 Débito</option><option value="convenio">🧾 Convênio</option></select></div>
                                    </div>
